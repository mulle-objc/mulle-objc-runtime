...
if( NOT MULLE_TESTALLOCATOR_LIBRARY)
   find_library( MULLE_TESTALLOCATOR_LIBRARY NAMES ${CMAKE_STATIC_LIBRARY_PREFIX}mulle-testallocator${CMAKE_STATIC_LIBRARY_SUFFIX} mulle-testallocator)
   ...
   if( MULLE_TESTALLOCATOR_LIBRARY)
      #
      # Add to MULLE_TESTALLOCATOR_LIBRARY list.
      # Disable with: `mark no-cmakeadd`
      #
      set( DEPENDENCY_LIBRARIES
         ${DEPENDENCY_LIBRARIES}
